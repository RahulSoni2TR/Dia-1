    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests()
                ...
                .requestMatchers("/login", "/register", "/logout", "*.css","/get-security-question","/reset-password","/verify-security-answer","/reset-ns-password","proxy-image").permitAll() 
                .requestMatchers("/add-product", "/modify-product", "/remove-product", "/set-price","/available-order-ids").hasRole("ADMIN")
